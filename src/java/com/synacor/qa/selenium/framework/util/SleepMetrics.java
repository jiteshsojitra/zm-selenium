...
public class SleepMetrics {
	 ...
	 * 
	 * @param stack
	 *            Current stack trace (i.e. (new Throwable()).getStackTrace())
	 * @param delay
	 *            The desired Sleep(msec) delay
	 * @param start
	 *            The start time of Sleep()
	 * @param finish
	 *            The finish time of Sleep() (i.e in case interrupted)
	 */
	public static void RecordSleep(StackTraceElement[] stack, long delay, Date start, Date finish) {

		for (StackTraceElement e : stack) {

			// Skip any non-synacor classes
			if (!e.getClassName().startsWith("selenium")) {
				continue;
			}
			...
			if (e.getClassName().startsWith("framework.util.SleepUtil")) {
				continue;
			}
	 ...
	 * 
	 * @param e
	 *            The stack element that requested the sleep (i.e. the class +
	 *            method)
	 * @param delay
	 *            The desired Sleep(msec) delay
	 * @param actual
	 *            The actual time of Sleep() (i.e in case interrupted)
	 */
	 ...
	 * 
	 * @param e
	 *            The stack element that processed (i.e. the class + method)
	 * @param actual
	 *            The total time (msec) that was spent processing
	 */
